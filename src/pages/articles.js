...
const FeaturedArticle = ({ img, title, time, summary, link }) => {
    return(
        <li className='relative col-span-1 w-full p-4 bg-light border border-solid border-dark rounded-2xl dark:bg-dark dark:text-light dark:border-light'>
            ...
            <Link className='w-full inline-block cursor-pointer overflow-hidden rounded-lg dark:text-light' href={link} target="_blank">
...
const articles = () => {
  return (
    <>
        <Head>
            <title>Samet Kabakçı | Makaleler</title>
            <meta name="description" content="Portfolio web site" />
        </Head>
        <TransitionEffect />
        <main className='w-full mb-16 flex flex-col items-center justify-center overflow-hidden'>
            <Layout className='pt-16'>
                <AnimatedText text="Kelimeler Dünyayı Değiştirebilir!" className='mb-16 lg:!text-7xl sm:mb-8 sm:!text-6xl xs:!text-4xl' />
                <ul className='grid grid-cols-2 gap-16 lg:gap-8 md:grid-cols-1 md:gap-y-16'>
                    ...
                    <FeaturedArticle 
                        ...
                        summary="Learn how to build a Form Validation In Reactjs: Build A Reusable Custom Hook For Inputs And Error Handling. Follow this step-by-step guide to integrate Pagination component in your ReactJS project."
                        time="7 DK Okuma"
                        link="/"
                        img={article3}
                    />
                    <FeaturedArticle 
                        ...
                        summary="Learn how to build a Silky Smooth Scrolling In Reactjs: A Step-By-Step Guide For React Developers. Follow this step-by-step guide to integrate Pagination component in your ReactJS project."
                        time="12 DK Okuma"
                        link="/"
                        img={article4}
                    />
                </ul>
                <h2 className='font-bold text-4xl w-full text-center my-16 mt-32 dark:text-light'>Tüm Makaleler</h2>
                <ul>
                    <Article 
